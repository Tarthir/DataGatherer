...
if len(sys.argv) != 3:
    print("Usage is p0fer.py <unzippedpcapFileLocation> <destinationLogLocation>")
    sys.exit(1)
pcapFilesLoc = sys.argv[1]
destLogLoc = sys.argv[2]
...
def p0f_file(unzipped_f,cnt,f_in):
    with open (unzipped_f,'wb') as f_out:
        ...
        logfile = '/home/tyler/data_gathering/p0f/p0fdata/p0finfo'+ str(cnt) +'.p0f'
