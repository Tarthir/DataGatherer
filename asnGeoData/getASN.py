...
asnData='/home/tyler/data_gathering/asnGeoData/asnData.asn' 
...
for file in os.listdir("/home/tyler/data_gathering/p0f/p0fdata"):
    #print(file)
...
# after running this script the bash script will run: netcat whois.cymru.com 43 < asnPreProcessedData.data | sort -n > asnFinalData.data
